...
import GetMethodParser from '../Utils/GetMethodParser';
...
export class TonClient {
    ...
    async getJettonWalletAddress(jettonMasterContract: Address, walletOwner: Address): Promise<Address> {
    ...
    async getJettonWalletData(jettonWallet: Address): Promise<{
        ...
        const {
            stack,
            exitCode,
        } = await this.callGetMethod(jettonWallet, 'get_wallet_data', []);
